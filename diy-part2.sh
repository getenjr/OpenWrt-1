...
sed -i 's/PKG_VERSION:=.*/PKG_VERSION:=8.3.9/g' feeds/packages/lang/php8/Makefile
sed -i 's/PKG_HASH:=.*/PKG_HASH:=bf4d7b8ea60a356064f88485278bd6f941a230ec16f0fc401574ce1445ad6c77/g' feeds/packages/lang/php8/Makefile
...
# python-dateutil
sed -i 's/PKG_VERSION:=.*/PKG_VERSION:=2.9.0/g' feeds/packages/lang/python/python-dateutil/Makefile
#sed -i 's/PKG_RELEASE:=.*/PKG_RELEASE:=1/g' feeds/packages/lang/python/python-dateutil/Makefile
sed -i 's/PKG_HASH:=.*/PKG_HASH:=78e73e19c63f5b20ffa567001531680d939dc042bf7850431877645523c66709/g' feeds/packages/lang/python/python-dateutil/Makefile
...
# dnsproxy
sed -i 's/PKG_VERSION:=.*/PKG_VERSION:=0.72.1/g' feeds/packages/net/dnsproxy/Makefile
sed -i 's/PKG_HASH:=.*/PKG_HASH:=482787733a980a862361c069c0f71b5f9bb765ae51c07d6a6c195f44e98189f6/g' feeds/packages/net/dnsproxy/Makefile
...
# frp
sed -i 's/PKG_VERSION:=.*/PKG_VERSION:=0.59.0/g' feeds/packages/net/frp/Makefile
sed -i 's/PKG_HASH:=.*/PKG_HASH:=eb4848119a9684b7762171d7633aa5ee29d195e63f53e89e7b549096bdf4a5a9/g' feeds/packages/net/frp/Makefile
